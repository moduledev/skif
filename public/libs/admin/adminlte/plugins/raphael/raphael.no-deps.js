...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "eve")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * or
     ...
     - callback (function) #optional callback function which is going to be executed in the context of newly created paper
     * or
     - all (array) (first 3 or 4 elements in the array are equal to [containerID, width, height] or [x, y, width, height]. The rest are element descriptions in format {type: type, <attribute>}). See @Paper.add.
     - callback (function) #optional callback function which is going to be executed in the context of newly created paper
     * or
    ...
    var loaded,
        ...
        Paper = function () {
             ...
             * Paper.customAttributes
             [ property (object) ]
             **
             * If you have a set of attribute that you would like to represent
             * as a function of some number you can do it easily with custom attribute:
             > Usage
     ...
     * want to wrap some common transformation or attribute in one method. In difference to canvas methods,
     ...
     *
     * Note: Glow is not connected to the element. If you change element attribute it won’t adjust itself.
     **
     > Parameters
     **
     ...
     **
     ...
     - params (object) #optional final attribute for the element, see also @Element.attr
     ...
     **
     > Parameters
     **
     - params (object) final attribute for the element, see also @Element.attr
     ...
     * Paper.add
     [ method ]
     **
     * Imports elements in JSON array in format `{type: type, <attribute>}`
     **
     > Parameters
     **
     - json (array)
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * Element.transform
     [ method ]
     **
     * Adds transformation to the element which is separate to other attribute,
     ...
     * or
     ...
     = (object) object of attribute if nothing is passed in.
     > Possible parameters
