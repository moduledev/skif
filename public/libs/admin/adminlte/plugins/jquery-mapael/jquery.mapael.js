...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        /*
         * Init the element "elem" on the map (drawing text, setting attribute, events, tooltip, ...)
         *
        ...
        initElem: function (id, type, elem) {
            ...
            if (elem.options.text && elem.options.text.content !== undefined) {
                ...
                // Apply SVG attribute to text element
         ...
         *
         * Refresh attribute and tooltips for areas and plots
        ...
        onUpdateEvent: function (e, opt) {
            ...
            // Update areas attribute and tooltips
            ...
            // Update plots attribute and tooltips
            ...
            // Update links attribute and tooltips
        ...
        /*
         * Set plot size attribute according to its type
        ...
        /*
         * Set the attribute on hover and the attribute to restore for a map element
         * @param elem the map element
         * @param originalAttrs the original attribute to restore on mouseout event
         * @param attrsHover the attribute to set on mouseover event
         */
         ...
         * This is needed for specific attribute like cursor who will not
         * be animated, and thus not set.
         *
         * If duration is set to 0 (or not set), no animation are performed
         * and attribute are directly set (and the callback directly called)
         */
        ...
        animate: function(element, attrs, duration, callback) {
            ...
            if (!element) return;
            if (duration > 0) {
                // Filter out non-animated attribute
                ...
                // Set non-animated attribute
                element.attr(attrsNonAnimated);
                // Start animation for all attribute
                element.animate(attrs, duration, 'linear', function() {
                    if (callback) callback();
                });
            } else {
                // No animation: simply set all attribute...
                element.attr(attrs);
