...
export default {
    ...
    methods: {
        ...
        getTask() {
            axios
                .get("/admin/dashboard/task/" + this.task)
                .then(resp => {
                    this.newEvent.name = resp.data.data.title
                    this.newEvent.description = resp.data.data.description
                    this.newEvent.start_date = resp.data.data.start
                    this.newEvent.end_date = resp.data.data.end
                })
                .catch(err => console.log(err.response.data));
        },
        resetForm() {
